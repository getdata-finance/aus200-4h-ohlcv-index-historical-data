# AUS200 4h OHLCV Stock index Historical Data — Free Sample

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE) [![Dataset rows](https://img.shields.io/badge/full_dataset-27_513_rows-blue)](https://getdata.finance/datasets/aus200) [![Updated](https://img.shields.io/badge/weekly_update-every_Saturday_8am_UTC-green)](https://getdata.finance) [![Full data on getdata.finance](https://img.shields.io/badge/download-getdata.finance-orange)](https://getdata.finance/datasets/aus200)

### -> [**Download the full AUS200 dataset on getdata.finance**](https://getdata.finance/datasets/aus200)

**AUS200 4h OHLCV stock index historical data** — ultra high-quality 4h OHLCV for **Australia 200**. Global cash and extended index sessions — Asia, Europe and US coverage, not US-hours only. Clean `datetime, open, high, low, close, volume` CSV for backtesting, algorithmic trading and quantitative research.
...
- **Free evaluation sample** on GitHub (`4h`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/aus200) · **27,513** `1m` rows in the full archive
...
> **Sample on GitHub** · `AUS200_4h.csv` (27,513 rows, `2008-09-10` -> `2026-07-31`). **Full archive on [getdata.finance](https://getdata.finance/datasets/aus200)** — **27,513** `1m` rows (~1.93 MB), **11 timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W), `2008-09-10` -> `2026-07-31`.
...
| 1m rows | 27,513 | **27,513** |
| Size | 1.96 MB | ~1.93 MB |
...
| --- | --- | --- | --- | --- | --- |
| 2008-09-10T00:00:00+00:00 | 4863.1 | 4899.54 | 4853.5 | 4890.54 | 468 |
| 2008-09-10T04:00:00+00:00 | 4890.54 | 4935.54 | 4879.54 | 4905.54 | 436 |
| 2008-09-10T08:00:00+00:00 | 4905.54 | 4926.54 | 4871.54 | 4871.54 | 125 |
| 2008-09-10T12:00:00+00:00 | 4871.54 | 4914.54 | 4851.54 | 4909.54 | 158 |
| 2008-09-10T16:00:00+00:00 | 4909.54 | 4954.54 | 4909.54 | 4915.54 | 79 |

**Last rows**

| datetime | open | high | low | close | volume |
| --- | --- | --- | --- | --- | --- |
| 2026-07-31T04:00:00+00:00 | 8980 | 9012.16 | 8961.6 | 9006.17 | 3504 |
| 2026-07-31T08:00:00+00:00 | 9006.17 | 9010.16 | 8974.65 | 8981.16 | 4516 |
| 2026-07-31T12:00:00+00:00 | 8981.16 | 8981.17 | 8884.66 | 8932.67 | 9572 |
| 2026-07-31T16:00:00+00:00 | 8932.67 | 8940.15 | 8917.15 | 8924.67 | 3851.0974279034 |
...
The complete **AUS200** archive on **[getdata.finance](https://getdata.finance/datasets/aus200)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **27,513** rows at `1m`, plus all other timeframes in the same ZIP.

**[-> Get the full AUS200 dataset on getdata.finance](https://getdata.finance/datasets/aus200)**

---
*GetData · AUS200 4h OHLCV sample on GitHub · Full historical data on [getdata.finance](https://getdata.finance/datasets/aus200) · 2026-08-05 UTC*
